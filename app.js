...
const translations = {
  en: {
    ...
    modernNigerian: 'Modern Nigerian',
    ...
    soilType: 'Soil Type',
    zoning: 'Zoning / Setback',
    consistencySeed: 'Consistency Seed',
    ...
    generateBtn: 'Generate Blueprints',
    savedProjects: 'Saved Projects',
    noProjects: 'No saved projects yet.\nGenerate and save your first design!',
    designOutput: 'Design Output',
    saveProject: '💾 Save Project',
    readyToGenerate: 'Ready to generate',
    view3D: '3D Isometric View',
    frontFacade: 'Front Facade',
    floorPlan: 'Floor Plan Layout',
    interiorView: 'Interior Cutaway View',
    techSpecs: 'Technical Specifications & Materials',
    generatingExterior: 'Generating exterior...',
    renderingFacade: 'Rendering facade...',
    drawingFloorPlan: 'Drawing floor plan...',
    visualizingInterior: 'Visualizing interior...',
    compilingSpecs: 'Compiling specifications...',
    ph3D: '3D view will appear here',
    phFacade: 'Front elevation will appear here',
    phFloorPlan: 'Floor plan will appear here',
    phInterior: 'Dollhouse interior will appear here',
    phSpecs: 'Technical specs will appear here',
  },
  ha: {
    plotConfig: 'Tsarin Fili',
    plotWidth: 'Fadin Fili',
    plotLength: 'Tsawon Fili',
    buildingType: 'Nau\'in Gini',
    bungalow: 'Bungalow',
    duplex: 'Duplex',
    terrace: 'Terrace',
    archStyle: 'Salon Gini',
    modernNigerian: 'Na Zamani na Najeriya',
    contemporary: 'Na Zamani',
    colonial: 'Colonial',
    minimalist: 'Mai Sauki',
    roofStyle: 'Salon Rufin',
    hipRoof: 'Rufi Mai Gangare',
    flatRoof: 'Rufi Mai Lebur',
    gableRoof: 'Rufi Mai Tsauni',
    mansard: 'Mansard',
    roomsLayout: 'Dakunan & Tsari',
    bedrooms: 'Dakunan Kwana',
    bathrooms: 'Gidajen Wanka',
    livingRoom: 'Dakin Zama',
    dining: 'Dakin Abinci',
    kitchen: 'Dakin Dafa',
    store: 'Ma\'aji',
    study: 'Dakin Karatu',
    garage: 'Garage',
    siteConditions: 'Yanayin Fili',
    soilType: 'Nau\'in Kasa',
    zoning: 'Yankin Gini',
    consistencySeed: 'Lambar Tsari',
    generationSeed: 'Lambar Samarwa',
    randomize: 'Zaɓi Bazuwar',
    seedInfo: '🔒 Lambar tsari tana kiyaye duk fitarwar guda daya',
    specificReqs: 'Bukatun Musamman',
    requirementsPlaceholder: 'Misali: Dakin kwana mai wanka...',
    generateBtn: 'Samar da Zane',
    savedProjects: 'Ayyukan da aka Adana',
    noProjects: 'Babu ayyukan da aka adana.\nSamar da zanen farko!',
    designOutput: 'Fitarwar Zane',
    saveProject: '💾 Adana Aikin',
    readyToGenerate: 'Shirye don samarwa',
    view3D: 'Kallonin 3D',
    frontFacade: 'Gaban Gini',
    floorPlan: 'Tsarin Bene',
    interiorView: 'Ciki na Gini',
    techSpecs: 'Bayanin Fasaha',
    generatingExterior: 'Ana samar da waje...',
    renderingFacade: 'Ana zana gaba...',
    drawingFloorPlan: 'Ana zana bene...',
    visualizingInterior: 'Ana nuna ciki...',
    compilingSpecs: 'Ana tattara bayanai...',
    ph3D: 'Kallonin 3D zai bayyana nan',
    phFacade: 'Gaban gini zai bayyana nan',
    phFloorPlan: 'Tsarin bene zai bayyana nan',
    phInterior: 'Cikin gini zai bayyana nan',
    phSpecs: 'Bayanin fasaha zai bayyana nan',
  },
  yo: {
    plotConfig: 'Ètò Ilẹ̀',
    plotWidth: 'Ìgboro Ilẹ̀',
    plotLength: 'Gígùn Ilẹ̀',
    buildingType: 'Irú Ilé',
    bungalow: 'Bungalow',
    duplex: 'Duplex',
    terrace: 'Terrace',
    archStyle: 'Ìpìlẹ̀ Ilé',
    modernNigerian: 'Òde-Òní Nàìjíríà',
    contemporary: 'Òde-Òní',
    colonial: 'Colonial',
    minimalist: 'Ìrọ̀rùn',
    roofStyle: 'Irú Orí Ilé',
    hipRoof: 'Orí Ilé Tó Yíká',
    flatRoof: 'Orí Ilé Pẹlẹbẹ',
    gableRoof: 'Orí Ilé Gígùn',
    mansard: 'Mansard',
    roomsLayout: 'Àwọn Yàrá & Ètò',
    bedrooms: 'Yàrá Orun',
    bathrooms: 'Yàrá Ìwẹ̀',
    livingRoom: 'Yàrá Ìgbé',
    dining: 'Yàrá Oúnjẹ',
    kitchen: 'Yàrá Sísè',
    store: 'Stóò',
    study: 'Yàrá Kíkọ́',
    garage: 'Garage',
    siteConditions: 'Ipò Ilẹ̀',
    soilType: 'Irú Ilẹ̀',
    zoning: 'Ipin Ilẹ̀',
    consistencySeed: 'Nọ́mbà Ìṣọ̀kan',
    generationSeed: 'Nọ́mbà Ìṣẹ̀dá',
    randomize: 'Yan Lọ́nà',
    seedInfo: '🔒 Nọ́mbà ìṣọ̀kan mú gbogbo èsì jọ',
    specificReqs: 'Àwọn Ìbéèrè Pàtàkì',
    requirementsPlaceholder: 'Fún àpẹẹrẹ: Yàrá orun olóye...',
    generateBtn: 'Ṣẹ̀dá Àwòrán',
    savedProjects: 'Àwọn Iṣẹ́ Tí A Pamọ́',
    noProjects: 'Kò sí iṣẹ́ tí a pamọ́.\nṢẹ̀dá àwòrán àkọ́kọ́!',
    designOutput: 'Ìyọrísí Àwòrán',
    saveProject: '💾 Pamọ́ Iṣẹ́',
    readyToGenerate: 'Ṣetán láti ṣẹ̀dá',
    view3D: 'Ìwòran 3D',
    frontFacade: 'Iwájú Ilé',
    floorPlan: 'Ètò Ilẹ̀ Ilé',
    interiorView: 'Inú Ilé',
    techSpecs: 'Àlàyé Ìmọ̀-ẹ̀rọ',
    generatingExterior: 'Ń ṣẹ̀dá ìta...',
    renderingFacade: 'Ń ṣe iwájú...',
    drawingFloorPlan: 'Ń ya ètò...',
    visualizingInterior: 'Ń ṣe inú...',
    compilingSpecs: 'Ń kojọ àlàyé...',
    ph3D: 'Ìwòran 3D yóò farahàn níbí',
    phFacade: 'Iwájú ilé yóò farahàn níbí',
    phFloorPlan: 'Ètò ilé yóò farahàn níbí',
    phInterior: 'Inú ilé yóò farahàn níbí',
    phSpecs: 'Àlàyé ìmọ̀-ẹ̀rọ yóò farahàn níbí',
  },
  ig: {
    plotConfig: 'Nhazi Ala',
    plotWidth: 'Obosara Ala',
    plotLength: 'Ogologo Ala',
    buildingType: 'Udi Ulo',
    bungalow: 'Bungalow',
    duplex: 'Duplex',
    terrace: 'Terrace',
    archStyle: 'Ụdị Ihe Owuwu',
    modernNigerian: 'Oge Ohuru Naịjirịa',
    contemporary: 'Nke Oge Ohuru',
    colonial: 'Colonial',
    minimalist: 'Nke Dị Mfe',
    roofStyle: 'Ụdị Elu Ulo',
    hipRoof: 'Elu Ulo Dị Gburugburu',
    flatRoof: 'Elu Ulo Dị Larịị',
    gableRoof: 'Elu Ulo Dị Elu',
    mansard: 'Mansard',
    roomsLayout: 'Ọnụ Ụlọ & Nhazi',
    bedrooms: 'Ụlọ Ụra',
    bathrooms: 'Ụlọ Mmiri',
    livingRoom: 'Ụlọ Obibi',
    dining: 'Ụlọ Oriri',
    kitchen: 'Ụlọ Esi',
    store: 'Ụlọ Ihe',
    study: 'Ụlọ Mmuta',
    garage: 'Garage',
    siteConditions: 'Ọnọdụ Ala',
    soilType: 'Ụdị Ala',
    zoning: 'Ngalaba Ala',
    consistencySeed: 'Nọmba Nhazi',
    generationSeed: 'Nọmba Mmepụta',
    randomize: 'Họrọ Ohere',
    seedInfo: '🔒 Nọmba nhazi na-echekwa mmepụta niile',
    specificReqs: 'Ihe A Chọrọ Kpọmkwem',
    requirementsPlaceholder: 'Ihe atụ: Ụlọ ụra nke ihe ọ bụla...',
    generateBtn: 'Mepụta Ihe Owuwu',
    savedProjects: 'Ọrụ Edekọtara',
    noProjects: 'Enweghị ọrụ edekọtara.\nMepụta ihe mbụ!',
    designOutput: 'Mmepụta Ihe Owuwu',
    saveProject: '💾 Chekwaa Ọrụ',
    readyToGenerate: 'Dị njikere imepụta',
    view3D: 'Ọhụụ 3D',
    frontFacade: 'Ihu Ulo',
    floorPlan: 'Atụmatụ Ala Ulo',
    interiorView: 'ime Ulo',
    techSpecs: 'Nkọwa Teknụzụ',
    generatingExterior: 'Na-emepụta mpụga...',
    renderingFacade: 'Na-ese ihu...',
    drawingFloorPlan: 'Na-ese atụmatụ...',
    visualizingInterior: 'Na-eme ime...',
    compilingSpecs: 'Na-anakọta nkọwa...',
    ph3D: 'Ọhụụ 3D ga-apụta ebe a',
    phFacade: 'Ihu ulo ga-apụta ebe a',
    phFloorPlan: 'Atụmatụ alo ga-apụta ebe a',
    phInterior: 'ime ulo ga-apụta ebe a',
    phSpecs: 'Nkọwa teknụzụ ga-apụta ebe a',
  },
  fr: {
    plotConfig: 'Configuration du Terrain',
    plotWidth: 'Largeur du Terrain',
    plotLength: 'Longueur du Terrain',
    buildingType: 'Type de Bâtiment',
    bungalow: 'Bungalow',
    duplex: 'Duplex',
    terrace: 'Terrasse',
    archStyle: 'Style Architectural',
    modernNigerian: 'Nigérian Moderne',
    contemporary: 'Contemporain',
    colonial: 'Colonial',
    minimalist: 'Minimaliste',
    roofStyle: 'Style de Toit',
    hipRoof: 'Toit en Croupe',
    flatRoof: 'Toit Plat',
    gableRoof: 'Toit à Pignon',
    mansard: 'Mansard',
    roomsLayout: 'Pièces & Disposition',
    bedrooms: 'Chambres',
    ...
    study: 'Bureau',
    garage: 'Garage',
    siteConditions: 'Conditions du Site',
    soilType: 'Type de Sol',
    zoning: 'Zonage / Recul',
    consistencySeed: 'Graine de Cohérence',
    generationSeed: 'Graine de Génération',
    randomize: 'Aléatoire',
    seedInfo: '🔒 La graine fixe garde les 4 sorties identiques',
    specificReqs: 'Exigences Spécifiques',
    requirementsPlaceholder: 'Ex: Suite parentale, cuisine ouverte...',
    generateBtn: 'Générer les Plans',
    savedProjects: 'Projets Sauvegardés',
    noProjects: 'Aucun projet sauvegardé.\nGénérez votre premier design!',
    designOutput: 'Résultat du Design',
    saveProject: '💾 Sauvegarder',
    readyToGenerate: 'Prêt à générer',
    view3D: 'Vue Isométrique 3D',
    frontFacade: 'Façade Avant',
    floorPlan: 'Plan de Masse',
    interiorView: 'Vue Intérieure',
    techSpecs: 'Spécifications Techniques',
    generatingExterior: 'Génération extérieure...',
    renderingFacade: 'Rendu de la façade...',
    drawingFloorPlan: 'Dessin du plan...',
    visualizingInterior: 'Visualisation intérieure...',
    compilingSpecs: 'Compilation des specs...',
    ph3D: 'La vue 3D apparaîtra ici',
    phFacade: 'La façade apparaîtra ici',
    phFloorPlan: 'Le plan apparaîtra ici',
    phInterior: 'L\'intérieur apparaîtra ici',
    phSpecs: 'Les specs apparaîtront ici',
  },
  ar: {
    plotConfig: 'تكوين القطعة',
    plotWidth: 'عرض القطعة',
    plotLength: 'طول القطعة',
    buildingType: 'نوع المبنى',
    bungalow: 'بنغالو',
    duplex: 'دوبلكس',
    terrace: 'تراس',
    archStyle: 'الطراز المعماري',
    modernNigerian: 'نيجيري حديث',
    contemporary: 'معاصر',
    colonial: 'استعماري',
    minimalist: 'بسيط',
    roofStyle: 'نوع السقف',
    ...
    soilType: 'نوع التربة',
    zoning: 'منطقة البناء',
    consistencySeed: 'بذرة الاتساق',
    generationSeed: 'بذرة التوليد',
    randomize: 'عشوائي',
    seedInfo: '🔒 البذرة الثابتة تحافظ على نفس المبنى',
    specificReqs: 'متطلبات خاصة',
    requirementsPlaceholder: 'مثال: غرفة رئيسية مع حمام...',
    generateBtn: 'توليد المخططات',
    savedProjects: 'المشاريع المحفوظة',
    noProjects: 'لا توجد مشاريع محفوظة.\nأنشئ تصميمك الأول!',
    designOutput: 'ناتج التصميم',
    saveProject: '💾 حفظ المشروع',
    readyToGenerate: 'جاهز للتوليد',
    view3D: 'عرض ثلاثي الأبعاد',
    frontFacade: 'الواجهة الأمامية',
    floorPlan: 'مخطط الطابق',
    interiorView: 'المنظر الداخلي',
    techSpecs: 'المواصفات التقنية',
    generatingExterior: 'جاري إنشاء الخارج...',
    renderingFacade: 'جاري رسم الواجهة...',
    drawingFloorPlan: 'جاري رسم المخطط...',
    visualizingInterior: 'جاري تصور الداخل...',
    compilingSpecs: 'جاري تجميع المواصفات...',
    ph3D: 'سيظهر العرض ثلاثي الأبعاد هنا',
    phFacade: 'ستظهر الواجهة هنا',
    phFloorPlan: 'سيظهر المخطط هنا',
    phInterior: 'سيظهر الداخل هنا',
    phSpecs: 'ستظهر المواصفات هنا',
  }
};
...
function applyLanguage(lang) {
  ...
  // Apply to all data-lang elements
...
async function callAI(prompt) {
  const GEMINI_KEY = 'AIzaSyDxPeCclVs0vYQuB2czhn7hE5llE73bdy8';
...
function generateFloorPlanSVG(config) {
  ...
  for (let i = 0; i < numBeds; i++) {
    rooms.push({ x:sx+i*bedW, y:sy+125, w:bedW, h:i===0?115:100, color:roomC.bedroom, label:i===0?'MASTER BED':'BED '+(i+1), sub:i===0?'4.5x4.0m':'3.5x3.5m' });
  }

  for (let i = 0; i < Math.min(parseInt(baths),2); i++) {
    rooms.push({ x:sx+numBeds*bedW, y:sy+125+i*58, w:80, h:55, color:roomC.bathroom, label:i===0?'BATH 1':'BATH 2', sub:'2.5x2.0m' });
  }
...
function generateInteriorSVG(config) {
  ...
  return `
    <svg viewBox="0 0 520 300" xmlns="http://www.w3.org/2000/svg" style="width:100%;border-radius:6px;">
      ...
      <polygon points="0,240 520,240 480,300 40,300" fill="${floorC}" opacity="0.6"/>
...
async function generate() {
  ...
  try {
    const specResult = await callAI(`Generate technical specifications for: ${baseDesign}. Include foundation type for ${soil} soil, structural system, wall construction, roofing material, floor area in sq ft, columns, plumbing, electrical panel, Nigerian climate materials, and 3 zoning notes for ${zoning}.`);
    ...
    showResult(4, 'Technical specs unavailable — check your API key.');
    showError('AI specs failed: ' + error.message + ' — Diagrams are ready!');
...
console.log('MY ArchGen — Settings + Language + SVG Ready!');
